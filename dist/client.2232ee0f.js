...
function xc(e, n, t, r, l, u, o, i, s) {
  (Et = !1), (Lr = null), Cc.apply(_c, arguments);
}
function Pc(e, n, t, r, l, u, o, i, s) {
  if ((xc.apply(this, arguments), Et)) {
    if (Et) {
      var c = Lr;
      (Et = !1), (Lr = null);
...
function Zu(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Qo(e, r), n & 4 && -1 < $c.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zt(l);
        if (
          (u !== null && Cs(u),
...
var ut = {
  ...
  Xo = ge(el),
  Qc = V({}, el, { dataTransfer: 0 }),
  Kc = ge(Qc),
  Yc = V({}, Gt, { relatedTarget: 0 }),
  xl = ge(Yc),
  Xc = V({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Gc = ge(Xc),
  Zc = V({}, ut, {
...
var rf = V({}, Gt, {
  ...
  sf = ge(of),
  af = V({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cf = ge(af),
  ff = V({}, el, {
    deltaX: function (e) {
...
var mf = Be && "TextEvent" in window && !Ct,
  Ls = Be && (!eo || (Ct && 8 < Ct && 11 >= Ct)),
...
function hf(e, n) {
  if (In)
    return e === "compositionend" || (!eo && Rs(e, n))
      ? ((e = Ts()), (kr = Ju = en = null), (In = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function Is(e) {
  if (e.propertyName === "value" && nl(Ft)) {
    var n = [];
    Os(n, Ft, e, Ku(e)), ms(gf, n);
  }
}
function kf(e, n, t) {
  e === "focusin"
    ? (ni(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", Is))
    : e === "focusout" && ni();
}
function Sf(e) {
...
var Pf = Be && "documentMode" in document && 11 >= document.documentMode,
  Fn = null,
  su = null,
  xt = null,
  au = !1;
...
for (var Tl = 0; Tl < ui.length; Tl++) {
  var Ll = ui[Tl],
    Nf = Ll.toLowerCase(),
    zf = Ll[0].toUpperCase() + Ll.slice(1);
  pn(Nf, "on" + zf);
}
pn($s, "onAnimationEnd");
...
var kt =
  ...
  Tf = new Set("cancel close invalid load scroll toggle".split(" ").concat(kt));
function oi(e, n, t) {
  ...
  if (!e[ar]) {
    (e[ar] = !0),
      qi.forEach(function (t) {
        t !== "selectionchange" && (Tf.has(t) || Rl(t, !1, e), Rl(t, !0, e));
      });
      ...
      P &&
        (Ls &&
          ...
          (In || P !== "onCompositionStart"
            ...
            : ((en = v),
              (Ju = "value" in en ? en.value : en.textContent),
              (In = !0))),
        (_ = Fr(c, P)),
        0 < _.length &&
        ...
        (x = mf ? vf(e, t) : hf(e, t)) &&
          ...
          0 < c.length &&
            ((v = new Go("onBeforeInput", "beforeinput", null, t, v)),
...
var pu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Of =
    typeof queueMicrotask == "function"
      ...
      : typeof ai < "u"
      ? function (e) {
          return ai.resolve(null).then(e).catch(Df);
        }
      : pu;
function Df(e) {
  setTimeout(function () {
...
function vn() {
  if (!Dl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), gs(Yu, vn), l);
    } finally {
      (M = n), (Dl = !1);
    }
  }
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        n !== null
          ? ((t = Pn !== null ? { id: Ve, overflow: Ae } : null),
            (e.memoizedState = {
              dehydrated: n,
              treeContext: t,
...
function ku(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = bs), ao(e);
  var u = n.contextType;
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
...
function vo(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (Cr.current = e === null || e.memoizedState === null ? Bf : Wf),
    (e = t(r, l)),
    Pt)
  ) {
    u = 0;
...
function Ni(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), ea(n, t, r), ku(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
  ...
  if (t)
    return n.flags & 256
      ...
      : ((u = r.fallback),
        ...
        (r.sibling = u),
        (n.child = r),
        (n.mode & 1) !== 0 && et(n, e.child, null, o),
        (n.child.memoizedState = xu(o)),
        (n.memoizedState = _u),
        u);
  if ((n.mode & 1) === 0) return pr(e, n, o, null);
  if (l.data === "$!") {
...
function Zf(e, n, t) {
  ...
  switch ((ro(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), Pu(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Da(e) {
  ...
  n !== null && ((e.alternate = null), Da(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[mu], delete n[If], delete n[Ff])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Wo(t), n === 1))
      e.tag === 0 ? jf(Fi.bind(null, e)) : Ys(Fi.bind(null, e)),
        Of(function () {
          (R & 6) === 0 && vn();
        }),
        (t = null);
...
function $a(e, n) {
  if (((Pr = -1), (Nr = 0), (R & 6) !== 0)) throw Error(y(327));
  var t = e.callbackNode;
...
function Tn(e) {
  ...
  try {
    ...
    (M = r), (Ee.transition = t), (R = n), (R & 6) === 0 && vn();
  }
}
function _o() {
  (pe = Wn.current), I(Wn);
  ...
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if ((e.lanes & t) === 0 && (n.flags & 128) === 0)
        return (ae = !1), Gf(e, n, t);
      ae = (e.flags & 131072) !== 0;
    }
  else (ae = !1), j && (n.flags & 1048576) !== 0 && Xs(n, Ar, n.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Xu(n, t | 1), de(n, W()), (R & 6) === 0 && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
ds = Co;
ps = Tn;
var vd = { usingClientEntryPoint: !1, Events: [Zt, Un, rl, cs, fs, Co] },
  ht = {
...
var Za,
  Ja,
  Vi = Xi.exports;
(Ja = Vi.createRoot), (Za = Vi.hydrateRoot);
const Iu = ({ value: e, name: n }) =>
  e
    ? Je.exports.createElement("astro-slot", {
        name: n,
...
const gd =
  ...
  (n, t, { default: r, ...l }, { client: u }) => {
    ...
    for (const [s, c] of Object.entries(l))
      t[s] = Je.exports.createElement(Iu, { value: c, name: s });
    const o = Je.exports.createElement(
        n,
        t,
        r != null ? Je.exports.createElement(Iu, { value: r }) : r
      ),
      i = yd(e);
    return (
      i && delete e[i],
      u === "only"
        ? Je.exports.startTransition(() => {
            Ja(e).render(o);
          })
        : Je.exports.startTransition(() => {
            Za(e, o);
